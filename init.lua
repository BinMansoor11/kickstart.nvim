...
-- See `:help 'confirm'`
-- In VS Code this stays off: a blocking "save changes?" dialog on window close freezes Neovim
-- until someone answers it, and nobody can. VS Code asks about unsaved files itself.
vim.o.confirm = not vim.g.vscode
